...
data class TaskId private constructor(override val value: String) :
    EventAggregateId(value) { //private constructor forces to use the safe creation methods below, instead of randomly guessing UUIDs
    companion object {
        fun generate(): TaskId {
