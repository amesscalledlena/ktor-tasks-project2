...
interface TaskRepository {
    ...
    fun findAllPaginated(limit: Int, offset: Long, status: TaskStatus?, priority: TaskPriority?, category: TaskCategory?): List<TaskDto>
    fun count(status: TaskStatus?, priority: TaskPriority?, category: TaskCategory?): Long
